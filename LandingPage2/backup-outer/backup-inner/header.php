        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="ml-auto navbar-nav">
                    ...
                    <?php }if($this->session->userdata('login_id')!=''){?>
                    <li class="post-ad"><a href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">My Profile</a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="<?php echo base_url('profile');?>">My Profile</a>
                        <a class="dropdown-item" href="<?php echo base_url('login/user_logout');?>">Signout</a>
                    </div>
                    </li>
