        ...
        <div class="row no-gutters">
            <div class="col-md-3 col-xs-12">
                ...
                <div class="dog-res" id="cat-res-1">
                    <ul>
                       <a href="<?php echo base_url('userdashboard');?>"><li id="cat-res-11" class="category-active-1 icon-next-1">My Profile
                            <i class="fa fa-angle-right"></i>
                        </li></a>
                        <a href="<?php echo base_url('myads');?>"><li id="cat-res-12" class="category-active-2 icon-next-1">my ads
                            <i class="fa fa-angle-right"></i>
                        </li></a>
                       ...
                       <!--  <a href="<?php //echo base_url('order');?>"><li id="cat-res-14" class="icon-next-1">payment details
                         ...
                         <a href="<?php echo base_url('discount');?>"><li id="cat-res-15" class="icon-next-1">buy - Credits
                            <i class="fa fa-angle-right"></i>
                        </li></a>
                      <a href="<?php echo base_url('addpost/add');?>"><li id="cat-res-16" class="icon-next-1">Post a new ad
                        <i class="fa fa-angle-right"></i>
                        </li></a>
                         <a href="<?php echo base_url('favourite');?>"><li id="cat-res-17" class="icon-next-1">favourite ads
                            <i class="fa fa-angle-right"></i>
                        </li></a>
                    </ul>
                </div>
